...
package com.android.kotlinstudy.utils.USB
    ...
    while (index < totalLength) {
        ...
        when (type) {
            UsbHelper.DESC_TYPE_INTERFACE -> {
                ...
                val nextInterface = ConfigurationDescriptor.InterfaceInfo(
                    intfId, intfEndpointCount,
            ...
            UsbHelper.DESC_TYPE_ENDPOINT -> {
                ...
                currentInterface.endpoints.add(
                    ConfigurationDescriptor.EndpointInfo(
                        endpointAddr,
                        endpointAttrs,
                        maxPacketSize,
                        epInterval
